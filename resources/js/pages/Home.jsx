        ...
        <div>
            ...
            {elements.map((element, index) => (
                <div key={index} className="my-1">
                    ...
                    <div style={{height:'450px'}} className="border rounded ">
                        <video src={`/storage/${element.dependencies}`} className='w-100 h-100' controls autoplay loop muted type="video/mp4" width={100}>
